...
public static void main(String args[]){ 
    ...
    System.out.println("++ and --");
        int i = 10;
        System.out.println("Incremental Postfix : " + i++);// confution
        System.out.println("Incremental Prefix : " + ++i); 
        System.out.println("Dicremental Postfix : " + i--); // confution
    ...
    System.out.println("***** Logical && and Bitwise & *****");
        System.out.println("Logical And : " + (10<20 && 5<20)); //The logical && operator doesn't check second condition if first condition is false.  
        System.out.println("Logical And : " + (10<20 & 5<20));  //The bitwise & operator always checks both conditions whether first condition is true or false.   
